...
const SidebarChef = () => {
  ...
  const menuItems = [
    ...
    { path: '/chef/modules', icon: faBook, label: 'Gérer les modules' },
    { path: '/chef/etudiants', icon: faUserGraduate, label: 'Gérer les étudiants' },
    { path: '/chef/rattrapages', icon: faCalendarCheck, label: 'Gérer les rattrapages' },
    { path: '/chef/unites-enseignement', icon: faFileAlt, label: 'Publier documents' },
    { path: '/chef/bulletins', icon: faFilePdf, label: 'Publier les bulletins' },
    { path: '/chef/emplois-temps', icon: faCalendarAlt, label: 'Emplois du temps' },
  ]
