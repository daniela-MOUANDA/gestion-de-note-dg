...
export const ROLE_MENUS = {
    ...
    DEP: [
        ...
        { path: '/dep/programmes', icon: faBook, label: 'Programmes' },
        { path: '/dep/emplois-du-temps', icon: faCalendarAlt, label: 'Emplois du temps' },
        { path: '/dep/enseignants', icon: faChalkboardTeacher, label: 'Enseignants' },
        { path: '/dep/evaluations', icon: faGraduationCap, label: 'Évaluations' },
        { path: '/admin/profil', icon: faUser, label: 'Profil' },
        { path: '/admin/parametres', icon: faCog, label: 'Paramètres' },
    ],
