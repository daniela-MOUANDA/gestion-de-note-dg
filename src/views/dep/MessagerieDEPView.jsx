...
const MessagerieDEPView = () => {
    ...
    const getEtudiants = (classe) => {
        ...
        return [
            { id: 1, nom: 'MBADINGA', prenom: 'Paul', matricule: `${filiereCode}2026-L${niveau}-001`, email: 'paul.mbadinga@student.inptic.ga' },
            { id: 2, nom: 'OBIANG', prenom: 'Sophie', matricule: `${filiereCode}2026-L${niveau}-002`, email: 'sophie.obiang@student.inptic.ga' },
            { id: 3, nom: 'NZAMBA', prenom: 'Jean', matricule: `${filiereCode}2026-L${niveau}-003`, email: 'jean.nzamba@student.inptic.ga' },
            { id: 4, nom: 'ONDO', prenom: 'Marie', matricule: `${filiereCode}2026-L${niveau}-004`, email: 'marie.ondo@student.inptic.ga' },
            { id: 5, nom: 'EKOMY', prenom: 'Pierre', matricule: `${filiereCode}2026-L${niveau}-005`, email: 'pierre.ekomy@student.inptic.ga' },
            { id: 6, nom: 'BITEGUE', prenom: 'Anne', matricule: `${filiereCode}2026-L${niveau}-006`, email: 'anne.bitegue@student.inptic.ga' },
            { id: 7, nom: 'MVOU', prenom: 'Patrick', matricule: `${filiereCode}2026-L${niveau}-007`, email: 'patrick.mvou@student.inptic.ga' },
            { id: 8, nom: 'EBANG', prenom: 'Claire', matricule: `${filiereCode}2026-L${niveau}-008`, email: 'claire.ebang@student.inptic.ga' }
        ]
    }
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex gap-4 pt-4">
                                    <button
                                        ...
                                        className={`flex-1 py-3 px-6 rounded-lg font-semibold text-white flex items-center justify-center gap-2 transition-all ${messageObjet && messageCorps
...
export default MessagerieDEPView
