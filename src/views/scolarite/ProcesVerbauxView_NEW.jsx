...
const ProcesVerbauxView = () => {
    ...
    '2024-2025': {
      ...
      'RT': {
        'L1': {
          ...
          'apres': {
            'S1': { effectif: 30, presents: 29, admis: 28, ajourne: 1, tauxReussite: 96.6, datePV: '2025-02-15', dateReception: '2025-02-16', president: 'Dr. EKOMY Paul', rapporteur: 'Pr. MINTSA Claire', statut: 'nouveau', envoyePar: 'Direction des Études Pédagogiques' },
            'S2': null,
            'annuel': null
          }
        },
        'L2': {
          'avant': { 'S1': null, 'S2': null, 'annuel': null },
          'apres': { 'S1': null, 'S2': null, 'annuel': null }
        },
        'L3': {
          'avant': { 'S1': null, 'S2': null, 'annuel': null },
          'apres': { 'S1': null, 'S2': null, 'annuel': null }
      ...
      'MTIC': {
        'L1': { 'avant': { 'S1': null, 'S2': null, 'annuel': null }, 'apres': { 'S1': null, 'S2': null, 'annuel': null } },
        'L2': { 'avant': { 'S1': null, 'S2': null, 'annuel': null }, 'apres': { 'S1': null, 'S2': null, 'annuel': null } },
        'L3': { 'avant': { 'S1': null, 'S2': null, 'annuel': null }, 'apres': { 'S1': null, 'S2': null, 'annuel': null } }
      },
      'AV': {
        'L1': { 'avant': { 'S1': null, 'S2': null, 'annuel': null }, 'apres': { 'S1': null, 'S2': null, 'annuel': null } },
        'L2': { 'avant': { 'S1': null, 'S2': null, 'annuel': null }, 'apres': { 'S1': null, 'S2': null, 'annuel': null } },
  ...
  const handleArchivePV = () => {
    ...
    setPvArchived(true)
    setTimeout(() => {
      alert(`PV archivé avec succès!\n\nLe PV de ${selectedFiliere} ${selectedNiveau} (${selectedTypeRattrapage === 'avant' ? 'Avant' : 'Après'} rattrapages - ${selectedTypePV === 'S1' ? 'Semestre 1' : selectedTypePV === 'S2' ? 'Semestre 2' : 'Annuel'}) a été transféré vers la section Archivage de la promotion ${selectedPromotion}.`)
    }, 100)
  }
  ...
  // Vue 4: Choix avant/après rattrapages
        ...
        <div className="flex flex-col lg:ml-64 min-h-screen">
          ...
          <main className="flex-1 p-4 sm:p-6 lg:p-8 pt-24">
            <div className="mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 mb-2">
                PV - {selectedFiliere} {selectedNiveau}
              </h1>
              <p className="text-sm sm:text-base text-slate-600">
  ...
  // Vue 5: Liste des PV (S1, S2, Annuel)
  if (!selectedTypePV) {
        ...
        <div className="flex flex-col lg:ml-64 min-h-screen">
          ...
          <main className="flex-1 p-4 sm:p-6 lg:p-8 pt-24">
            <div className="mb-6">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 mb-2">
                PV - {selectedFiliere} {selectedNiveau} • {selectedTypeRattrapage === 'avant' ? 'Avant' : 'Après'} Rattrapages
              </h1>
              <p className="text-sm sm:text-base text-slate-600">
      ...
      <div className="flex flex-col lg:ml-64 min-h-screen">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 pt-24">
          <div className="mb-6">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 mb-2">
              Procès-Verbal - {selectedFiliere} {selectedNiveau}
            </h1>
            <p className="text-sm sm:text-base text-slate-600">
                  ...
                  <div className="bg-slate-50 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-slate-800">{selectedNiveau}</span>
                      </div>
                      <div className="flex justify-between">
              ...
              <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
                ...
                <div className="bg-slate-50 rounded-lg p-4 mb-6 text-sm">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-slate-600">Filière:</span>
                      <span className="font-semibold text-slate-800">{selectedFiliere} {selectedNiveau}</span>
                    </div>
                    <div className="flex justify-between">
